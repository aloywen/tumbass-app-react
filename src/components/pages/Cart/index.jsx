...
export default function Index() {
    ...
    const grandTot = store.cart.reduce((prev, curr) => prev + curr.grandprice, 0)
                ...
                <div className='fixed bottom-0 w-full bg-slate-100 md:bg-transparent md:w-4/12 md:top-0 md:relative md:mr-14'>
                    <div className='p-4 shadow-lg w-full m-2'>
                        ...
                        <div className='flex justify-between'>
                            ...
                            <p className="font-primary mt-3">Rp. {grandTot}</p>
                        ...
                        <div className='flex justify-between mt-3'>
                            ...
                            <p className="font-primary font-semibold mt-3">Rp. {grandTot}</p>
