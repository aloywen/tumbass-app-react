...
export default function Index() {
    ...
    let totalCart = data.data.totalCart
    // let count = 0
                        ...
                        <div>
                            <Link to="/cart">
                                <div className='flex gap-0'>
                                    ...
                                    <span className='bg-red-600 rounded-full w-5 h-5 text-sm flex justify-center items-center text-white -ml-2'>{totalCart}</span>
                                </div>
                            </Link>
                        </div>
